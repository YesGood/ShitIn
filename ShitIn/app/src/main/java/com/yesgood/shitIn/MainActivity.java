        ...
        GoogleMap.OnMarkerClickListener
{
  ...
  private ParseQueryAdapter<ToiletDataPost> postsQueryAdapter;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ParseQueryAdapter.QueryFactory<ToiletDataPost> factory =
        new ParseQueryAdapter.QueryFactory<ToiletDataPost>() {
          public ParseQuery<ToiletDataPost> create() {
    ...
    postsQueryAdapter = new ParseQueryAdapter<ToiletDataPost>(this, factory) {
      @Override
      public View getItemView(ToiletDataPost post, View view, ViewGroup parent) {
        if (view == null) {
          view = View.inflate(getContext(), R.layout.anywall_post_item, null);
        }
        TextView contentView = (TextView) view.findViewById(R.id.content_view);
        TextView usernameView = (TextView) view.findViewById(R.id.username_view);
        TextView typeView = (TextView) view.findViewById(R.id.tvType);
    ...
    postsListView.setOnItemClickListener(new OnItemClickListener() {
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        final ToiletDataPost item = postsQueryAdapter.getItem(position);
    ...
    postButton.setOnClickListener(new OnClickListener() {
      public void onClick(View v) {
        ...
        CreateNewToilet createNewToilet = CreateNewToilet.newInstance();
          createNewToilet.setLocation(myLoc);
        createNewToilet.show(fm,"test");
  ...
  private void doMapQuery() {
    ...
    ParseQuery<ToiletDataPost> mapQuery = ToiletDataPost.getQuery();
    ...
    mapQuery.findInBackground(new FindCallback<ToiletDataPost>() {
      @Override
      public void done(List<ToiletDataPost> objects, ParseException e) {
        if (e != null) {
          if (Application.APPDEBUG) {
        ...
        for (ToiletDataPost post : objects) {
